...
_TEMPLATE_PATH = ("templates", "article.md")


def render_document(document: Document, *, template_source: str | None = None) -> str:
    ...
    return template.render(
        ...
        body=_html_to_markdown(document.html_content),
    )
